 ...
 * interface, etc.).
 *
 * May 2, 2017: re-used "as is" in WIP Traceroute.
 */
...
public:
    ...
    RouteInterface(InetAddress ip, unsigned char iTTL, bool timeout = false);
    ~RouteInterface();
    
    // "iTTL" is the inferred initial TTL of "Time exceeded" message
